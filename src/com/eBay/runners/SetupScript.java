...
public final class SetupScript {
	...
	private static String APP_ACTIVITY = PropertiesHelper.getProperty("DesiredCapabilities", "appiumDriver");
    ...
    public static void setUp() throws IOException {
    	...
    	try {                                  
			setDriver(new AndroidDriver<WebElement>(new URL(APPIUM_DRIVER), capabilities));
	...
	private static void setDriver(AndroidDriver<WebElement> driver) {
